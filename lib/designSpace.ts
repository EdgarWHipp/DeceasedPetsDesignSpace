  ...
  },
  {
    ...
    positions: [
      ...
      },
      {
        ...
        examples: ['lifelike hologram', 'realistic robot', 'photo scene'],
    ...
    positions: [
      {
        ...
        definition:
          'What someone who knew the pet put into words: memories, descriptions, notes, a questionnaire.',
        examples: ['written memories', 'a described personality', 'an answered questionnaire'],
        story: 'built from what the people who knew it could put into words',
      },
      {
        id: 'D7-P2',
        label: 'Objective Data',
        definition:
          'What a device or an institution recorded, including the owner\u2019s own photos.',
  ...
  },
  {
    ...
    positions: [
      ...
      },
      {
        ...
        examples: ['farewell ritual', 'final visit'],
  ...
  },
  {
    ...
    positions: [
      ...
      },
      {
        ...
        examples: ['online tribute', 'communal ceremony'],
...
export const PRESETS: {
  ...
  },
  {
    name: 'PVP Pet Game',
    blurb:
      'A stylized game companion that plays back, waiting inside the game until you start a session.',
    selection: {
      D1: 'D1-P1',
      D2: 'D2-P1',
      D3: 'D3-P3',
